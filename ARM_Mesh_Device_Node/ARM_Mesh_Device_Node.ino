...
Task taskSendMessage(TASK_SECOND * 3, TASK_FOREVER, &sendMessage);  //change message transmission rate
...
void receivedCallback(uint32_t from, String &msg) {
  ...
  if (msg == "t") {
    Serial.println("Received 't' message");
    if (ledState == false) {
    ...
    // Handle the simple 't' message here if needed
  } else {
